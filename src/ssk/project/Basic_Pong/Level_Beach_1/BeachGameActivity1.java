...
public class BeachGameActivity1 extends FragmentActivity {
	
	BeachGameView1 gameView;
	MediaPlayer mp;	
	
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(gameView = new BeachGameView1(this));
		
		this.setVolumeControlStream(AudioManager.STREAM_MUSIC);
		mp = MediaPlayer.create(this, R.raw.test_magix);
		mp.setLooping(true);
        mp.start();
	}
