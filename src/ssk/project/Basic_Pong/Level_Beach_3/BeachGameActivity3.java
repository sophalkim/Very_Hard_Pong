...
public class BeachGameActivity3 extends FragmentActivity {
	
	BeachGameView3 gameView;
	MediaPlayer mp;	
	
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(gameView = new BeachGameView3(this));
		
		this.setVolumeControlStream(AudioManager.STREAM_MUSIC);
		mp = MediaPlayer.create(this, R.raw.beach_music);
		mp.setLooping(true);
        mp.start();
	}
